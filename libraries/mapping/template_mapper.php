...
class Template_mapper
{
    ...
    public function map($story)
    {
        ...
        $data = array(
            'npr_id' => $story->id,
            'npr_audio' => $audio_array,
            'npr_audioRunByDate' => $story->audioRunByDate,
            'npr_bylines' => $bylines,
            'npr_corrections' => $corrections,
            'npr_html_assets' => $html_assets,
            'npr_images' => $images,
            'npr_keywords' => $story->keywords,
            'npr_lastModifiedDate' => $story->lastModifiedDate,
            'npr_miniTeaser' => $story->miniTeaser,
            'npr_organization' => $org_array,
            'npr_permalink' => $permalink,
            'npr_priorityKeywords' => $story->priorityKeywords,
            'npr_pubDate' => $story->pubDate,
            'npr_pullquotes' => $pullquotes,
            'npr_shortTitle' => $story->shortTitle,
            'npr_slug' => $story->slug,
            'npr_subtitle' => $story->subtitle,
            'npr_storyDate' => $story->storyDate,
            'npr_teaser' => $story->teaser,
            'npr_text' => $text,
            'npr_thumbnails' => $thumbnail_array,
            'npr_title' => $story->title,
            'npr_toenails' => $toenail_array
        );
